...
struct GPUAnimBitmap {
	...
	char* state1, *state2;
    void    *dataBlock;
    void (*fAnim)(uchar4*,void*,char*, char*);
    void (*animExit)(void*);
    ...
    void anim_and_exit( void (*f)(uchar4*,void*,char*, char*), void(*e)(void*) ) {
    ...
    static void idle_func( void ) {
		...
		if(++ticks%2==0)
			bitmap->fAnim( devPtr, bitmap->dataBlock, bitmap->state1, bitmap->state2);
		else
			bitmap->fAnim( devPtr, bitmap->dataBlock, bitmap->state2, bitmap->state1);
